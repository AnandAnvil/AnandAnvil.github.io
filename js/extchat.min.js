...
var Runchat = function chatInit(conf) {
  ...
  $chat.tid = conf.tid;
  $chat.logdomain = "https://quality.vizru.com";
  $chat.domain = "https://quality.vizru.com";
  $chat.SocketDomain = "https://www.realtimeserver.tk/";
  ...
  var customDiv = {
    typing:
      ...
      $chat.botName +
      '</label><b><img src="../../../ui-themes/karma/images/chat_typing-dots-speed-2.gif"></b></section>',
  ...
  function buildFileUpload(filenames, category, tag) {
    ...
    <div class="file-itemsBox"><div class="file-item-fields"><span class="file-icon"><i class="icon-file-document"></i></span><span class="file-name" title="${
        file.name
        }">${file.name}</span></div>
    ${categoryDiv}${tagsDiv}
    </div>
